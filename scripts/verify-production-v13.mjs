...
for(const source of [domain,studentUi,financeUi,securityUi]){
...
console.log('Production v13 verification passed: deterministic boot, canonical payments, native certificates, finance/security modules.');