...
for(const token of ['certificateManagerReceipt:true','certificateManagerReceiptDoesNotMutateFinance:true','certificateManagerReceiptAsksFundsLocation:true','وسائل الدفع الإلكترونية','البنك','certManagerReceiptV22'])need(cert,token,'certificate manager receipt '+token);
need(cert,'certificateManagerRows(from,to)','certificate manager uses period rows');
