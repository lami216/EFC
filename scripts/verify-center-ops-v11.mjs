...
if (index.indexOf('./assets/production-center-ops-v11.js') < index.indexOf('./assets/production-license-gate-v8.js')) {
  throw new Error('Center ops v11 must be declared after the license gate.');
}
