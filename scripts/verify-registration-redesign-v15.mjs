...
requireText(index,'20260916-fiscal-year-current-v14-2','updated branch cache token');
requireText(gate,"RUNTIME_VERSION='20260916-fiscal-year-current-v14-2'",'runtime cache token matches index after certificate finance simplification');
