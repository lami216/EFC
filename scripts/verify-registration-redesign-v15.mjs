...
requireText(index,'20260915-receipt-edit-hour-duration-5','updated branch cache token');
requireText(gate,"RUNTIME_VERSION='20260915-receipt-edit-hour-duration-5'",'runtime cache token matches index after certificate finance simplification');
