...
requireText(index,'./assets/production-accounting-integrity-v21.js?v=20260918-finance-period-v22-2','index loads accounting integrity with synchronized cache version');
