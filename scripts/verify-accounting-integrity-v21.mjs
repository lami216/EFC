...
requireText(index,'./assets/production-accounting-integrity-v21.js?v=20260919-expense-seq-ledger-responsive-v28-1','index loads accounting integrity with synchronized cache version');
const gateScript=index.indexOf('./assets/production-license-gate-v8.js?v=20260919-expense-seq-ledger-responsive-v28-1'),integrityScript=index.indexOf('./assets/production-accounting-integrity-v21.js?v=20260919-expense-seq-ledger-responsive-v28-1');
