...
requireText(index,'./assets/production-accounting-integrity-v21.js?v=20260921-debt-route-select-fix-1','index loads accounting integrity with synchronized cache version');
const gateScript=index.indexOf('./assets/production-license-gate-v8.js?v=20260921-debt-route-select-fix-1'),integrityScript=index.indexOf('./assets/production-accounting-integrity-v21.js?v=20260921-debt-route-select-fix-1');
