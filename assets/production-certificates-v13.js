...
function drawCertificateHistory(){
  ...
  const caption=document.getElementById('certRecordsRangeV48');if(caption)caption.textContent=modeValue==='weekly'?range.label:modeValue==='daily'?`يوم ${range.label}`:modeValue==='monthly'?`شهر ${range.label}`:range.label;
...
function renderCertificateHistoryPage(){
  ...
  document.body.classList.remove('efc-certificate-finance-open-v43','efc-certificate-editing-v44');document.body.classList.add('efc-certificates-redesign-v35','efc-certificates-workspace-v36','efc-certificate-records-open-v48');
...
html body .content:has(.cert-records-card-v47) .cert-records-count-v47>span{display:grid!important;gap:2px!important;min-width:0!important}html body .content:has(.cert-records-card-v47) .cert-records-count-v47 small{font-size:10px!important;font-weight:800!important;color:#35564d!important}html body .content:has(.cert-records-card-v47) .cert-records-count-v47 em{font-style:normal!important;font-size:8px!important;font-weight:700!important;color:#6d817a!important;white-space:nowrap!important}html body .content:has(.cert-records-card-v47) .cert-records-count-v47 b{font-size:17px!important;color:#0a5f4d!important}
...
@media(max-height:650px) and (max-width:1100px){
  ...
  html body.efc-certificate-finance-open-v43 .cert-finance-topbar-v43{margin-bottom:6px!important}
...
function renderCertificates(){
  ...
  currentPage='certificates';document.body.classList.remove('efc-certificate-records-open-v48');document.body.classList.add('efc-certificates-redesign-v35','efc-certificates-workspace-v36');
