...
function receiptEditStudentMarkup(receipt){
  ...
  return`<div class="efc-cert-selected-main-v38"><span class="efc-cert-selected-kicker-v38">الطالب المرتبط بالروسي</span><strong>${esc(receipt.studentName||'—')}</strong><div class="efc-cert-selected-facts-v38"><span><small>الهاتف</small><b>${esc(receipt.phone||'—')}</b></span><span><small>رقم السجل</small><b>${esc(reg)}</b></span><span><small>الفرع</small><b>${esc(receipt.branchName||'—')}</b></span><span><small>الدورة</small><b>${esc(receipt.specialtyName||'—')}</b></span></div></div>`;
}
...
function renderCertificateHistoryPage(){
  ...
  document.body.classList.remove('efc-certificate-finance-open-v43','efc-certificate-editing-v44');
  document.body.classList.add('efc-certificates-redesign-v35','efc-certificates-workspace-v36','efc-certificate-records-open-v47');
  const rows=renderHistoryRows(),count=state.certificateReceipts.length;
  shell(`<section class="cert-records-hero-v47">${HISTORY_ICON}<h1>سجل الشهادات</h1></section><div class="cert-records-topbar-v47"><button class="button secondary cert-records-back-v47" id="certRecordsBackV47" type="button">${BACK_ICON}<span>العودة للشهادات</span></button><div class="cert-records-count-v47"><small>عدد الشهادات</small><b>${count}</b></div></div><div class="card cert-records-card-v47">${table(['رقم الروسي','الطالب','النوع','الفرع','الدورة','المبلغ','الوسيلة','التاريخ'],rows)}</div>`);
  document.getElementById('certRecordsBackV47')?.addEventListener('click',renderCertificates);
  document.querySelectorAll('.cert-records-card-v47 .cert-history-row-v13').forEach(row=>row.addEventListener('click',()=>{const receipt=state.certificateReceipts.find(item=>item.id===row.dataset.certificate);if(receipt)openReceipt(receipt);}));
}
...
html body.efc-certificate-finance-open-v43 .cert-finance-topbar-v43{width:100%!important;display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important;margin:0 0 8px!important;direction:rtl!important}
html body.efc-certificate-finance-open-v43 .cert-finance-topbar-v43>.cert-finance-primary-summary-v45{flex:0 1 330px!important;width:min(330px,38vw)!important;min-width:245px!important;margin:0!important}
...
html body.efc-certificate-finance-open-v43 .cert-finance-primary-summary-v45{direction:rtl!important}
...
html body.efc-certificate-finance-open-v43 .cert-finance-controls-v13[data-mode="daily"]{grid-template-columns:132px 154px 110px 158px 120px!important;justify-content:start!important}
html body.efc-certificate-finance-open-v43 .cert-finance-controls-v13[data-mode="monthly"]{grid-template-columns:132px 96px 78px 110px 158px 120px!important;justify-content:start!important}
html body.efc-certificate-finance-open-v43 .cert-finance-controls-v13[data-mode="yearly"]{grid-template-columns:132px 84px 110px 158px 120px!important;justify-content:start!important}
html body.efc-certificate-finance-open-v43 .cert-finance-specialty-v46{width:158px!important;max-width:158px!important}
...
html body.efc-certificate-records-open-v47 .content{width:min(900px,calc(100% - 24px))!important;max-width:900px!important;min-width:0!important;margin:0 12px 0 auto!important;padding:12px 0 20px!important;box-sizing:border-box!important;overflow:visible!important}
html body.efc-certificate-records-open-v47 .cert-records-hero-v47{width:min(470px,100%)!important;height:76px!important;margin:0 auto 12px!important;border-radius:15px!important;background:linear-gradient(110deg,#dcf6ee 0%,#e8faf5 68%,#e4f7f2 100%)!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:20px!important;color:#073f35!important;box-shadow:0 9px 24px rgba(17,89,70,.045)!important;position:relative!important}
html body.efc-certificate-records-open-v47 .cert-records-hero-v47::after{content:""!important;position:absolute!important;bottom:10px!important;left:50%!important;width:48px!important;height:3px!important;border-radius:99px!important;background:#0b7b62!important;transform:translateX(-50%)!important}
html body.efc-certificate-records-open-v47 .cert-records-hero-v47 svg{width:39px!important;height:39px!important;flex:0 0 39px!important}html body.efc-certificate-records-open-v47 .cert-records-hero-v47 h1{margin:0!important;font-size:31px!important;font-weight:850!important}
html body.efc-certificate-records-open-v47 .cert-records-topbar-v47{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important;margin:0 0 8px!important;direction:rtl!important}
html body.efc-certificate-records-open-v47 .cert-records-back-v47{height:36px!important;padding:0 14px!important;border-radius:9px!important;display:inline-flex!important;align-items:center!important;gap:7px!important}html body.efc-certificate-records-open-v47 .cert-records-back-v47 svg{width:16px!important;height:16px!important}
html body.efc-certificate-records-open-v47 .cert-records-count-v47{min-width:150px!important;height:48px!important;padding:6px 12px!important;border:1px solid #b9ddd5!important;border-radius:10px!important;background:linear-gradient(135deg,#eef9fb,#e8f5f2)!important;display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important;direction:rtl!important}
html body.efc-certificate-records-open-v47 .cert-records-count-v47 small{font-size:10px!important;font-weight:800!important;color:#35564d!important}html body.efc-certificate-records-open-v47 .cert-records-count-v47 b{font-size:17px!important;color:#0a5f4d!important}
html body.efc-certificate-records-open-v47 .cert-records-card-v47{padding:0!important;border:1.2px solid #aaccc1!important;border-radius:11px!important;overflow:hidden!important;background:#fff!important}
html body.efc-certificate-records-open-v47 .cert-records-card-v47 .table-wrap{max-height:calc(100dvh - 205px)!important;overflow:auto!important;border:0!important;border-radius:0!important}
html body.efc-certificate-records-open-v47 .cert-records-card-v47 table{min-width:790px!important;width:100%!important;border-collapse:collapse!important}html body.efc-certificate-records-open-v47 .cert-records-card-v47 th{position:sticky!important;top:0!important;z-index:2!important;height:39px!important;background:linear-gradient(180deg,#0a715b,#075846)!important;color:#fff!important;text-align:center!important;font-size:10px!important}html body.efc-certificate-records-open-v47 .cert-records-card-v47 td{height:37px!important;padding:6px 9px!important;text-align:center!important;font-size:10px!important}html body.efc-certificate-records-open-v47 .cert-records-card-v47 tbody tr{cursor:pointer!important}html body.efc-certificate-records-open-v47 .cert-records-card-v47 tbody tr:hover td{background:#e7f5ef!important}
...
@media(max-width:940px){
  ...
  html body.efc-certificate-finance-open-v43 .cert-finance-topbar-v43{flex-wrap:wrap!important}
  html body.efc-certificate-finance-open-v43 .cert-finance-topbar-v43>.cert-finance-primary-summary-v45{order:3!important;flex:1 1 100%!important;width:100%!important;min-width:0!important}
}
`;
...
function drawCertificateFinance(){
  ...
  root.innerHTML=`<div class="grid three breakdowns"><div class="card"><h3>حسب الفرع</h3>${breakdownHtml(row=>row.branchName||'—')}</div><div class="card"><h3>حسب الشهادة / الدورة</h3>${breakdownHtml(row=>row.specialtyName||'—')}</div><div class="card"><h3>حسب وسيلة الدفع</h3>${breakdownHtml(row=>row.method||'—')}</div></div>`;
}
...
function renderCertificates(){
  ...
  currentPage='certificates';document.body.classList.remove('efc-certificate-records-open-v47');document.body.classList.add('efc-certificates-redesign-v35','efc-certificates-workspace-v36');
  ...
  ['certFinanceBranchV13','certFinanceSpecialtyV13','certFinanceMethodV13'].forEach(id=>document.getElementById(id)?.addEventListener('change',drawCertificateFinance));
...
window.addEventListener('hashchange',()=>{if(location.hash!=='#certificates')document.body.classList.remove('efc-certificate-records-open-v47');});
